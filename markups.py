...
wrong_text_markup = InlineKeyboardMarkup(row_width=1)
...
help_btn = InlineKeyboardButton(text='❓ Помощь', callback_data='help_message')
start_btn = InlineKeyboardButton(text='👀 Начать', callback_data='help_message')
...
main_menu.insert(help_btn)

start_menu.insert(start_btn)
wrong_text_markup.insert(help_btn)
wrong_text_markup.insert(to_main_menu_btn)
